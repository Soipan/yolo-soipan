...
THe debugging measures takes are trying to alter the code according to research and resources i have found but nothing has changed. I have also made several alterations to the code itself in the client and backend code files in the folg
