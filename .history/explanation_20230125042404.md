...
However, the mongo db pvc displays pending as its status, the frontend deployment has crashed severally despite all the efforts i have made to try and correct that and the mongo db statefulset is 
