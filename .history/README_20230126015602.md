...
Tied to the database are .yaml files that facilitate for persistent volume has been created. This also is done through facilitating for persistence volume claim that ensures that products input that will be taken as data is not lost.
