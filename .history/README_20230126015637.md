...
Tied to the database are .yaml files that facilitate for persistent volumes to further ensure no dT. This also is done through facilitating for persistence volume claim that ensures that products input that will be taken as data is not lost.
