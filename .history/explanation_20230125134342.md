...
I have advanced some more on the debugging measures and it has mongo db run efectively and the persistent volume and persistent volume cka files successfully created.
