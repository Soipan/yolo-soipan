...
However, the frontend is not yet up. I still have issues with the error showing a CrashLoopBackOff and the error on the pod being it Does not have minimum availability. I have 
