...
I have advanced some more on the debugging measures and it has mongo db run efectively and the persistent volume and persistent volume claim files successfully created. This has also seent
