...
## 6. Challenges faced ( Working on it)
...
## 7. Google K8s Project Deployment expound 
 ## Use of StatefulSets
...
## 8. Mongo manifests file details for review 
...
## 9. Running of the application and debugging measures applied
...
## 10. Github commits on Google K8s Engine Project Deployment
