...
Tied to the database, is are .yaml file to facilitate for persistent storage has been created. This also is done through facilitating for persistence volume claim that ensures that products input that will be taken as data is not lost.
