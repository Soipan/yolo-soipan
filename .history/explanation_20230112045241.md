...
5. Github commits 
Outlined below are the commits that outline how i was able to dockerize the application and what facilitated efficient running. It's order is from the newest to the oldest. 
