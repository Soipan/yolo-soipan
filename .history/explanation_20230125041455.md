...
To expose the created pods to the internet, i have implemented services tied to the affected pods that will help facilitate access to the internet. The services used is node-service for the frontend and backend together with mongo service for the 
