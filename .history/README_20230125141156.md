...
The mongo manifest files are unavailable for viewing because they are a clone from google cloud hence it cannot be seen. A breakdown of the affected file contents is outlined on the explanation.md file at point 7. 
