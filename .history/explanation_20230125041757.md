...
Tied to the database, a yaml file to facilitate for persistent storage has been created. This also is done through facilitating for persistence volume claim that 
