...
Upon execution of the app on GKE, pods, services and the persistent volumes are created. Among these, some are successful i.e the backend deployment and mongo dv
